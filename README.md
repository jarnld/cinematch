...
- Six-question, mobile-friendly recommendation flow
...
2. Pull canonical metadata from TMDB and live regional availability from a licensed availability provider.
...
- TMDB for movie metadata and imagery (respecting attribution/licensing requirements)
